...
The `@EnableMongoRepositories` annotation activates Spring Data MongoDB. Spring Data MongoDB will create a concrete implementation of the `PersonRepository` and configure it to talk to a MongoDB database.
